...
export function AdminLoginForm() {
  ...
  return (
    <form onSubmit={submit} className="surface mx-auto w-full max-w-md p-8 sm:p-10">
      <p className="eyebrow">Admin entrance</p>
      <h1 className="mt-4 text-4xl font-semibold tracking-[-0.04em] text-zinc-950">管理后台ログイン</h1>
